---
id: video-5-mlma
title: "Video 5: Kraken Bitcoin Trading Bot"
sidebar_label: "Video 5: Kraken Trading Bot"
sidebar_position: 6
slug: /youtube-code/video-5-mlma
description: Automate a Kraken Bitcoin trading bot from TradingView signals using Nightshark. This walkthrough includes the indicator code and automation setup for sending crypto trade signals to Kraken.
keywords: [Kraken Bitcoin trading bot, Kraken automation, TradingView to Kraken, Nightshark Kraken bot, crypto trading automation, Bitcoin trading bot, TradingView crypto bot, automated Kraken trades]
---
...
<VideoStructuredData
  videoId="nsV64J4o0Ck"
  uploadDate="2025-05-25T20:54:59-07:00"
  duration="PT10M"
/>
...
# Video 5: Kraken Bitcoin Trading Bot

This walkthrough shows how to automate trades from a TradingView indicator to Kraken broker. Copy the Pine Script into TradingView, attach it to a chart, and configure the automation to send signals from your indicator to Kraken for execution.
...
<div style={{textAlign: 'center', margin: '2rem 0'}}>
  <iframe
    width="100%"
    height="617"
    src="https://www.youtube.com/embed/nsV64J4o0Ck"
