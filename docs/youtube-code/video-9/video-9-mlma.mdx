...
This setup requires the installation of Git. Please download and install Git from this link: [https://git-scm.com/install/windows](https://git-scm.com/install/windows)
:::
...
; =========================
timeDelay := 9                ; activation window in minutes
Entry := 0.85                 ; enter when side price >= 75c
