...
export default function LiveTradingVpnIcon() {
  return (
    ...
    >
      ...
      <span className={styles.tooltipBubble} aria-hidden="true">
        {tooltipText}
      </span>
    </span>
  );
